...
public class StudentController {
    ...
    public ResponseEntity<String> addStudentTeacherPair(@RequestParam String student, @RequestParam String teacher){
        service.addteacherandStudent(student,teacher);
    ...
    public ResponseEntity<List<String>> getStudentsByTeacherName(@PathVariable String teacher){
        ...
        students = service.getStudentbyTeacher(teacher);
    ...
    public ResponseEntity<String> deleteTeacherByName(@RequestParam String teacher){
        service.deleteteacherallstudent(teacher);
        return new ResponseEntity<>(teacher + " removed successfully", HttpStatus.CREATED);
    }
    @DeleteMapping("/delete-all-teachers")
    public ResponseEntity<String> deleteAllTeachers(@RequestParam String teacher){
        service.deleteallteacher(teacher);
